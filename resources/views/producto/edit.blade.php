    ...
    <div class="container w-100 border border-3 border-primary rounded p-4 mt-3">
        <form action="{{route('productos.update',['producto'=>$producto])}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                ...
                <!-- Fecha de Vencimiento de Producto -->
                <div class="col-md-6">
                 ...
                 <!-- Imagen de Producto -->
                 <div class="col-md-6">
                    <label for="img_path" class="form-label">Cargar una imagen</label>
                ...
                <!-- Marcas -->
                <div class="col-md-6">
                    <label for="marca_id" class="form-label">Elegir Marca</label>
                ...
                <!-- Presentaciones -->
                <div class="col-md-6">
                    <label for="presentacione_id" class="form-label">Elegir Presentación</label>
                   <select name="presentacione_id" id="presentacione_id" class="form-select">
                ...
                <!-- Categorias -->
                <div class="col-md-6">
                    <label for="categorias" class="form-label">Elegir Categoría</label>
                   <select name="categorias" id="categorias" class="form-select">
                    @foreach ($categorias as $item)
                    @if ($producto->categoria == $item->id)
                    <option selected value="{{$item->id}}" {{old('categorias') == $item->id ? 'selected' : ''}} >{{$item->nombre}}</option>
                    @else
